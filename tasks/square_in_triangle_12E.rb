# Trying to get Square in triangle in 12E
...
# steps = [:perp, :circle, :circle, :circle] # we know it works. But we want to save a move here
steps = [:circle, :circle, :line, :line, :line]
